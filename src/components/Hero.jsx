...
import pratibhaVideo from '../assets/videos/pratibhavideo.mp4'
import groupp from '../assets/images/groupp.jpeg'

const Hero = () => {
  return (

    <div className="px-4 sm:px-12 lg:px-24 xl:px-40 pt-6 pb-8">
      ...
      <div className="flex justify-center my-1">
        ...
        <div className='inline-flex items-center gap-2 border border-gray-300 p-1.5 pr-4 rounded-full'>
          ...
          <img
            className='w-20 object-cover rounded-3xl'
            src={groupp}
            alt="Groupp"
          />

          <p className='text-xs font-medium'>
            Trusted by 120+ Schools & Colleges
          </p>
